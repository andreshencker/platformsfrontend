            ...
            <section className="section full bg-dark">
                <div className="container center">
                    ...
                    <div className="row center reveal delay-3" style={{justifyContent:"center"}}>
                        <a href="/trades" className="btn btn-primary">Ver mis Trades</a>
                        <a href="/positions" className="btn btn-outline">Posiciones Abiertas</a>
                    </div>
            ...
            <section className="section container grid grid-2 reveal delay-1">
                <div className="card">
                    ...
                    <div className="row" style={{marginTop:12}}>
                        <a href="/income" className="btn btn-outline">Ver Ingresos</a>
